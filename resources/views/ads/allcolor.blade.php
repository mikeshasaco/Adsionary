...
<div class="container">
    <div class="row">
             <div class="col-md-12 col-sm-12">
                     <h4 style="text-align: center" >Prodominately used Advertisements Colors for According to our Database </h4>
                 ...
                 <div class="selectagcategory">
                  <select onchange="if (this.value) window.location.href=this.value" style="margin-top:5%; " class="media-select">
                        ...
                        <option value="{{ url('/data/industry/color'.'/'. $categoryselect->id)  }}">{{ $categoryselect->industryname }}</option>
                    @endforeach
                    </select>
                </div>
  ...
  <div class="skills" >
      ...
      <div class="skill">
        <div class="skill-name">{{number_format($type->total,0)}}% of Advertisements used {{$type->colorname}} as the prodominately used color</div>
        <div class="skill-bar">
        <div class="skill-per" per="{{$type->total}}">{{$type->colorname}}</div>
        </div>
        @endforeach
      </div>
