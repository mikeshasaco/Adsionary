...
<div class="container">
 ...
 --}}
        ...
        <div class="col-md-9">
                <div class="well">
                  <h2 style="margin-top:85px;">Add Color</h2>

                <form method="post" action="{{route('color.store')}}"  style="margin-top:2%;" >
                        {{ csrf_field() }}
                        <div class="form-group" >
                            <label for="name control-label">Enter Color</label>
                            <input type="text" class="form-control" id="colorname" placeholder="Enter Color" name="colorname">
